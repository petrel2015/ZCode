...
const zhCN: Record<string, string> = {
  ...
  "settings.usage.rateTrend.timingDetail": "模型请求 {model} · 本地执行 {local}（并行累计）",
  "settings.usage.rateTrend.prevDay": "前一天",
  "settings.usage.rateTrend.nextDay": "后一天",
  ...
  "tokenDebug.summary.avgTps": "平均输出速率 (token/s)",
  "tokenDebug.summary.lastTps": "最近一轮速率 (token/s)",
